...
class SnapshotPlugin {
    ...
    constructor(t, opts) {
        ...
        this.#provider = opts.snapshotProvider || pp || provider_js_1.SnapshotProviderDefault;
    ...
    matchSnapshot(found, ...[msg, extra]) {
        ...
        if (typeof found !== 'string') {
            ...
            const format = this.#formatSnapshot || defaultFormatSnapshot(this.#compareOptions);
            found = format(found);
            if (typeof found !== 'string') {
    ...
    static #getFilename(t, opts) {
        ...
        const args = core_1.argvRelative.slice(2);
