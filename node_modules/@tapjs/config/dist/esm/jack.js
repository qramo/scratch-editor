...
export default jack({
    ...
    .description(`Print the set of loaders and other node arguments in use, so that
  ...
  `,
    ...
    .description(`Tap is opinionated about coverage. Code coverage is good, and full
    ...
    .description(`These configuration options tell the runner which test suites to include
    ...
    .description(`It is sometimes useful to send raw TAP data to another TAP-consuming
